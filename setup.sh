...
mv stable-diffusion-v1-5/v1-5-pruned.ckpt stable-diffusion-webui/models/Stable-diffusion/
mv stable-diffusion-v1-5/v1-inference.yaml stable-diffusion-webui/models/Stable-diffusion/v1-inference.yaml
